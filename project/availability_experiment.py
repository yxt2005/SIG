...
def base_solver_args(common: Namespace, *, algorithm: str, scale: float, demand_row: int, seed: int, output_root: str):
    ...
    data = {
        ...
        "link_cvar_bound": common.link_cvar_bound,
        "layered2_node_risk_mode": common.layered2_node_risk_mode,
        "layered2_node_cvar_bound": common.layered2_node_cvar_bound,
...
def default_common_args(**overrides):
    data = {
        ...
        "layered2_node_risk_mode": "weighted",
